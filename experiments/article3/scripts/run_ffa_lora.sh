#!/usr/bin/env bash
set -euo pipefail
# run_ffa_lora.sh <sigma> <seed> [rounds] [tag_suffix]
#
# Artigo 3 — FFA-LoRA (FL_LORA_MODE=ffa, lora_A frozen, only lora_B trainable):
...
TAG="a3_ffa_lora_sigma${SIGMA}_seed${SEED}${TAG_SUFFIX}"
