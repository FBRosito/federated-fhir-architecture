...
def fresh_model() -> PeftModel:
    """Build a fresh PubMedBERT + LoRA model for one diagnostic run."""
...
try:
    ...
    print(
        f"STANDARD mode training step: SUCCESS, loss={out.loss.item():.4f}, epsilon={eps:.6f}"
    )
except Exception:
    import traceback
